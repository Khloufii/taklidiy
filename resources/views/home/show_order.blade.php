            ...
            <div class="content-wrapper">
              ...
              <table class="cnter">
                ...
                <tr class="th_color">
                  ...
                  <th class="th_deg">delivery atatus</th>
                ...
                <tr class="font_size">
                  ...
                  <td>
                    @if ($order->delivery_status=='processing')
                       <a onclick="return confirm('are you shour to cansol this')" class="btn btn-danger" href="{{url('cansol_order',$order->id)}}">cansol order</a>
